...
export const ExerciseCard = ({ name, id, muscle }: ExerciseCardProps) => {
  return (
    <>
      <li
        key={id}
        className="border-2 rounded border-brand-3 hover:border-brand-2 max-w-full lg:max-w-[45%] h-[110px] flex flex-col gap-[2px] items-center justify-center hover:text-grey-10 text-body1 text-grey-5"
      >
